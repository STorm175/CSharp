...
namespace winrt::webview2Demo::implementation
{
    ...
    struct MainWindowT : public ::winrt::webview2Demo::implementation::MainWindow_base<D,
        ...
        I...>
    {
        ...
        ::winrt::Microsoft::UI::Xaml::Controls::WebView2 MyWebView()
        {
            return _MyWebView;
        }
        void MyWebView(::winrt::Microsoft::UI::Xaml::Controls::WebView2 value)
        {
            _MyWebView = value;
        }
    ...
    private:
        ...
        ::winrt::Microsoft::UI::Xaml::Controls::WebView2 _MyWebView{nullptr};
    };
}
